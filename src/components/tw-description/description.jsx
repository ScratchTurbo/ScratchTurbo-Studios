...
class Renderer {
    ...
    project (id) {
        if (/^\d{6,}$/.test(id)) {
            return (
                <a
                    href={`https://studios-scratchturbo.replit.app/#${id}`}
                >
                    {`#${id}`}
                </a>
            );
        ...
        return (
            <a
                href={`https://scratchturbo.replit.app/search?q=%23${id}`}
                target="_blank"
                rel="noreferrer"
            >
                {`#${id}`}
    ...
    mention (name) {
        return (
            <a
                href={`https://scratchturbo.replit.app/profile?user=${name}`}
                target="_blank"
                rel="noreferrer"
            >
                {`@${name}`}
    ...
    emoji (name) {
        return (
            <img
                src={`https://scratchturbo.github.io/ScratchTurbo-ObjectLibraries/files/emojis/${name}.png`}
                alt={`:${name}:`}
                title={`:${name}:`}
