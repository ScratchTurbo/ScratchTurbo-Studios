...
const formatProjectTitle = _title => {
    ...
    return title.replace(emojiRegex, match => {
        ...
        return `<img
            src="https://scratchturbo.github.io/ScratchTurbo-ObjectLibraries/files/emojis/${emojiName}.png"
            alt=":${emojiName}:"
            title=":${emojiName}:"
        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    defaultMessage="ScratchTurbo, PenguinMod and TurboWarp are not affiliated with Scratch, the Scratch Team, or the Scratch Foundation."
                    description="Disclaimer that ScratchTurbo, PenguinMod and TurboWarp are not connected to Scratch"
            ...
            <div className={styles.footerColumns}>
                ...
                <div className={styles.footerSection}>
                    <a href="https://packager-scratchturbo.replit.app/">
                        {/* Do not translate */}
                        {'ElectraMod Packager'}
                    </a>
                    ...
                    <a href="https://electramod-docs.vercel.app/">
                        <FormattedMessage
                ...
                <div className={styles.footerSection}>
                    <a href="https://electramod.vercel.app/terms">
                        <FormattedMessage
                    ...
                    <a href="https://electramod.vercel.app/privacy">
                        <FormattedMessage
                    ...
                    <a href="https://discord.gg/9TSAK7jEED">
                        <FormattedMessage
                    ...
                    <a href="https://github.com/ElectraMod">
                        <FormattedMessage
...
class Interface extends React.Component {
    ...
    handleUpdateProjectTitle (title, isDefault) {
        if (isDefault || !title) {
            document.title = `ScratchTurbo - ${this.props.intl.formatMessage(messages.defaultTitle)}`;
        } else {
            document.title = `${title} - ScrachTurbo`;
        }
    }
    copyProjectLink (id) {
            ...
            >
                ...
                >
                    ...
                    {isHomepage && projectId !== '0' && title && extraProjectInfo && extraProjectInfo.author && <div className={styles.projectDetails}>
                        <a
                            target="_blank"
                            href={`https://scratchturbo.replit.app/profile?user=${extraProjectInfo.author}`}
                            rel="noreferrer"
                        >
                            <img
                    ...
                    {isHomepage ? (
                        <React.Fragment>
                                ...
                                <div className={styles.unsharedUpdate}>
                                    <div style={{display: 'flex', flexDirection: 'row'}}>
                                        <a
                                            style={{height: '32px'}}
                                            target="_blank"
                                            href={`https://scratchturbo.replit.app/profile?user=${remixedProjectInfo.author}`}
                                            rel="noreferrer"
                                        >
                                            <img
                            ...
                            <a
                                target="_blank"
                                href="https://scratchturbo.replit.app/search?q=all:projects"
                                rel="noreferrer"
                            >
                                See more projects
                            </a>
