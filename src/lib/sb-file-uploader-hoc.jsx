    ...
    class SBFileUploaderComponent extends React.Component {
        ...
        createFileObjects () {
            ...
            if (FileSystemAPI.available()) {
                ...
                this.inputElement.accept = '.sb,.sb2,.sb3,.pm,.pmp,.sturbo,.electra';
        ...
        handleChange (e) {
            ...
            if (thisFileInput.files) { // Don't attempt to load if no file was selected
                ...
                if (uploadAllowed) {
                    ...
                    if (handle) {
                        if (this.fileToUpload.name.endsWith('.sturbo') || this.fileToUpload.name.endsWith('.pmp')) {
        ...
        getProjectTitleFromFilename (fileInputFilename) {
            ...
            // (.sb, .sb2, and .sb3)
            const matches = fileInputFilename.match(/^(.*)(\.sb[23]?|\.pm|\.pmp\.sturbo)$/);
            if (!matches) return '';
