...
const PACKAGER_URL = 'https://packager-scratchturbo.replit.app/';
const PACKAGER_ORIGIN = "https://scratchturbo.replit.app/";
    ...
    class PackagerIntegrationComponent extends React.Component {
        ...
        handleMessage(e) {
            ...
            this.props.vm.saveProjectSb3('arraybuffer')
                .then(buffer => {
                    const name = `${this.props.reduxProjectTitle}.sturbo`;
                    e.source.postMessage({
                        p4: {
                            type: 'finish-import',
                            data: buffer,
